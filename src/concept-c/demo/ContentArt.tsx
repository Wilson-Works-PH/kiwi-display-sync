...
const THEMES: Record<
  ArtTheme,
  { bg: string; fg: string; accent: string; soft: string; onAccent: string }
> = {
  lime: {
    bg: "linear-gradient(135deg, #ceed7a 0%, #dcf09f 100%)",
    fg: "#2d0d29",
    accent: "#3d0d37",
    soft: "rgba(45,13,41,0.12)",
    onAccent: "#f3f9d4",
  },
  plum: {
    bg: "linear-gradient(135deg, #3d0d37 0%, #54154d 100%)",
    fg: "#f3f9d4",
    accent: "#ceed7a",
    soft: "rgba(243,249,212,0.14)",
    onAccent: "#2d0d29",
  },
  cream: {
    bg: "linear-gradient(135deg, #f3f9d4 0%, #ffffff 100%)",
    fg: "#2d0d29",
    accent: "#96507e",
    soft: "rgba(45,13,41,0.1)",
    onAccent: "#ffffff",
  },
  leaf: {
    bg: "linear-gradient(135deg, #7fa060 0%, #c1d786 100%)",
    fg: "#ffffff",
    accent: "#2d0d29",
  ...
  mauve: {
    bg: "linear-gradient(135deg, #96507e 0%, #7b4167 100%)",
    fg: "#ffffff",
    accent: "#ceed7a",
  ...
  dark: {
    bg: "linear-gradient(135deg, #2d0d29 0%, #1a0718 100%)",
    fg: "#f3f9d4",
    accent: "#ceed7a",
    soft: "rgba(243,249,212,0.12)",
    onAccent: "#2d0d29",
  },
};
    ...
    return (
      ...
      >
        ...
        >
          ...
          {art.sub ? (
            <div style={{ fontSize: "3.4cqi", opacity: 0.8 }}>{art.sub}</div>
          ) : null}
        </div>
        <div
          className="mt-auto grid grid-cols-2"
          style={{ columnGap: "6cqi", rowGap: "2.2cqi", marginTop: "4cqi" }}
        >
          {(art.items ?? []).map((it) => (
            <div
              key={it.label}
              ...
              style={{
                ...
                paddingBottom: "1.4cqi",
              }}
            >
              <span style={{ fontSize: "3.6cqi", fontWeight: 600 }}>
                {it.label}
              </span>
              <span
                style={{ fontSize: "3.6cqi", fontWeight: 800, color: t.accent }}
              >
                {it.value}
              </span>
            </div>
        ...
        {art.footer ? (
          <div
            style={{ marginTop: "3.5cqi", fontSize: "2.8cqi", opacity: 0.7 }}
          >
            {art.footer}
          </div>
        ) : null}
      ...
      >
        ...
        >
          {(art.items ?? []).map((it, i) => (
            ...
            >
              <div style={{ fontSize: "2.8cqi", opacity: 0.75 }}>
                {it.label}
              </div>
              <div
                style={{
              ...
              <div
                ...
                style={{ gap: "0.8cqi", height: "3.5cqi", marginTop: "1.6cqi" }}
              >
        ...
        {art.footer ? (
          <div style={{ marginTop: "3cqi", fontSize: "2.8cqi", opacity: 0.7 }}>
            {art.footer}
          </div>
        ) : null}
      </div>
    ...
    return (
      ...
      >
        ...
        >
          ...
          {art.sub ? (
            <div style={{ fontSize: "5cqi", fontWeight: 600, opacity: 0.85 }}>
              {art.sub}
            </div>
          ) : null}
        </div>
        <div className="mt-auto grid grid-cols-3" style={{ gap: "2.5cqi" }}>
          {(art.items ?? []).map((it) => (
            ...
            >
              <div style={{ fontSize: "2.6cqi", opacity: 0.75 }}>
                {it.label}
              </div>
              <div
                style={{
  ...
  if (kind === "welcome") {
    ...
    return (
      ...
      >
        ...
        {art.sub ? (
          <div style={{ fontSize: "4.2cqi", opacity: 0.85, marginTop: "3cqi" }}>
            {art.sub}
          </div>
        ) : null}
        {art.footer && kiwi ? (
